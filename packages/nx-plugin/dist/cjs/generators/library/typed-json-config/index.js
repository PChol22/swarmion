...
var _tsconfigBuild = require("./tsconfig.build.json");
Object.keys(_tsconfigBuild).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _tsconfigBuild[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _tsconfigBuild[key];
    }
  });
});
