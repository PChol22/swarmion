export var projectName = 'swarmion';
export var region = 'eu-west-1';
export var frameworkVersion = '>=3.0.0';
export var defaultEnvironment = 'dev';
export var sharedProviderConfig = {
  name: 'aws',
  runtime: 'nodejs16.x',
  architecture: 'arm64',
  region: region,
...
export var sharedEsbuildConfig = {
  packager: 'pnpm',
  bundle: true,
  minify: true,
  keepNames: true,
